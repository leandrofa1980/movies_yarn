create table tb_movie (count integer, score double, id bigint not null auto_increment, image varchar(255), title varchar(255), primary key (id)) engine=InnoDB;
create table tb_score (valor double, movie_id bigint not null, user_id bigint not null, primary key (movie_id, user_id)) engine=InnoDB;
...
INSERT INTO tb_score(movie_id, user_id, valor) VALUES (1, 1, 5.0);
INSERT INTO tb_score(movie_id, user_id, valor) VALUES (1, 2, 4.0);
INSERT INTO tb_score(movie_id, user_id, valor) VALUES (2, 1, 3.0);
INSERT INTO tb_score(movie_id, user_id, valor) VALUES (2, 3, 4.0);
